    ...
    const { signup, login, refresh, logout, current, uploadAvatar, verification, newVerificationEmail } = require('../../controlers/controlers.js')
    ...
    router.post('/verify/', newVerificationEmail)
